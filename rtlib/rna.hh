...
inline int hl_energy(const Basic_Subsequence<alphabet, pos_type> &a) {
  ...
  for (unsigned k = 0; k < a.seq->rows(); k++)
    energy += hl_energy(a.seq->row(k), a.i-1, a.j, a.seq->window_left_border, a.seq->window_right_border);
...
inline int hl_energy_stem(const Basic_Subsequence<alphabet, pos_type> &a) {
  ...
  for (unsigned k = 0; k < a.seq->rows(); k++)
    energy += hl_energy_stem(a.seq->row(k), a.i-1, a.j, a.seq->window_left_border, a.seq->window_right_border);
...
inline int il_energy(const Basic_Subsequence<alphabet, pos_type> &a,
  ...
  for (unsigned k = 0; k < a.seq->rows(); k++)
    energy += il_energy(a.seq->row(k), a.i-1, a.j, b.i-1, b.j, a.seq->window_left_border, a.seq->window_right_border);
...
inline int sr_energy(const Basic_Subsequence<alphabet, pos_type> &a,
  ...
  for (unsigned k = 0; k < a.seq->rows(); k++)
    energy += sr_energy(a.seq->row(k), a.i, b.j-1, a.seq->window_left_border, a.seq->window_right_border);
...
inline int dl_energy(const Basic_Subsequence<alphabet, pos_type> &a,
  ...
  for (unsigned k = 0; k < a.seq->rows(); k++)
    energy += dl_energy(a.seq->row(k), a.i, b.j-1, a.seq->window_left_border);
...
inline int dr_energy(const Basic_Subsequence<alphabet, pos_type> &a,
  ...
  for (unsigned k = 0; k < a.seq->rows(); k++)
    energy += dr_energy(a.seq->row(k), a.i, b.j-1, a.seq->window_right_border);
...
inline int dli_energy(const Basic_Subsequence<alphabet, pos_type> &a,
  ...
  for (unsigned k = 0; k < a.seq->rows(); k++)
    energy += dli_energy(a.seq->row(k), a.i, b.j-1, a.seq->window_right_border);
...
inline int dri_energy(const Basic_Subsequence<alphabet, pos_type> &a,
  ...
  for (unsigned k = 0; k < a.seq->rows(); k++)
    energy += dri_energy(a.seq->row(k), a.i, b.j-1, a.seq->window_left_border);
...
inline int ext_mismatch_energy(const Basic_Subsequence<alphabet, pos_type> &a,
  ...
  for (unsigned k = 0; k < a.seq->rows(); k++)
    energy += ext_mismatch_energy(a.seq->row(k), a.i, b.j-1, a.seq->window_left_border, a.seq->window_right_border);
...
inline int ml_mismatch_energy(const Basic_Subsequence<alphabet, pos_type> &a,
  ...
  for (unsigned k = 0; k < a.seq->rows(); k++)
    energy += ml_mismatch_energy(a.seq->row(k), a.i, b.j-1, a.seq->window_left_border, a.seq->window_right_border);
