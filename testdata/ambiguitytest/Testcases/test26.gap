...
grammar test1 uses test (axiom = sequence) {
	sequence =	nil (EMPTY)		|
				non_nil_seq		# h;
...
grammar test2 uses test (axiom = sequence) {
	sequence =	nil (EMPTY)		|
				non_nil_seq		# h;
	non_nil_seq = 	right (sequence, CHAR)			|
					left (CHAR, sequence)			|
...
instance testInst1 = test1 (testAlg1);
instance countInst1 = test1 (cntAlg);

instance testInst2 = test2 (testAlg1);
