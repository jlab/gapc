...
grammar test uses test (axiom = sequence) {
	...
	non_nil_seq = 	right (sequence, CHAR)			|
					left (CHAR, sequence)			|
					pair (CHAR, pair (CHAR, pair (CHAR, pair (CHAR, pair (CHAR, pair (CHAR, pair (CHAR, pair (CHAR, pair (CHAR, pair (CHAR, pair (CHAR, pair (CHAR, pair (CHAR, pair (CHAR, pair (CHAR, pair (CHAR, pair (CHAR, pair (CHAR, pair (CHAR, pair (CHAR, pair (CHAR, pair (CHAR, pair (CHAR, pair (CHAR, pair (CHAR, sequence, CHAR) with char_basepairing, CHAR) with char_basepairing, CHAR) with char_basepairing, CHAR) with char_basepairing, CHAR) with char_basepairing, CHAR) with char_basepairing, CHAR) with char_basepairing, CHAR) with char_basepairing, CHAR) with char_basepairing, CHAR) with char_basepairing, CHAR) with char_basepairing, CHAR) with char_basepairing, CHAR) with char_basepairing, CHAR) with char_basepairing, CHAR) with char_basepairing, CHAR) with char_basepairing, CHAR) with char_basepairing, CHAR) with char_basepairing, CHAR) with char_basepairing, CHAR) with char_basepairing, CHAR) with char_basepairing, CHAR) with char_basepairing, CHAR) with char_basepairing, CHAR) with char_basepairing, CHAR) with char_basepairing	|
