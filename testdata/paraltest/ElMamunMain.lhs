...
>        when (a == "timecount")
>          (putStrLn $ unlines $ map show $ bill (time *** count) b)
>        when (a == "timecalc")
>          (putStrLn $ unlines $ map show $ bill (time *** calc) b)
>        when (a == "timecalcpretty")
>          (putStrLn $ unlines $ map show $ bill ((time *** calc) *** prettyprint) b)
