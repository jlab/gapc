...
> stack_dg a b c d = error ("stack_dg: not in table" ++ show [a,b,c,d] ++ "\n")
...
> bl_energy seq bl (i,j) br | size == 1 = entropy + stacking
>                           | size  > 1 = entropy + termaupenalty (seq!bl)    (seq!br)
>                                                 + termaupenalty (seq!(j+1)) (seq!(br-1))
...
> br_energy seq bl (i,j) br  | size == 1 =  entropy + stacking 
>                            | size  > 1 =  entropy + termaupenalty (seq!bl)     (seq!br) 
>                                                   + termaupenalty (seq!(bl+1)) (seq!i)
...
> dr_energy seq (i,j)
>                | j < n     = dr_dangle_dg ((seq!i),(seq!j)) (seq!(j+1))
>                | otherwise = 0
>                       where (_,n)= bounds seq
...
> dl_energy seq (i,j) 
>           | i > 1     = dl_dangle_dg (seq!(i-1)) ((seq!i),(seq!j))
>           | otherwise = 0
