...
class Table_Decl : public Base {
 private:
  ...
  Fn_Def *fn_untab_;
  Fn_Def *fn_tab_;
  Fn_Def *fn_set_traces_;
  Fn_Def *fn_get_traces_;
  Fn_Def *fn_get_tab_;
  Fn_Def *fn_size_;
 ...
 public:
  ...
  const Fn_Def &fn_set_traces() const { return *fn_set_traces_; }
  const Fn_Def &fn_get_traces() const { return *fn_get_traces_; }
