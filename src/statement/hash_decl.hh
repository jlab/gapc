...
#ifndef SRC_STATEMENT_HASH_DECL_HH_
#define SRC_STATEMENT_HASH_DECL_HH_
...
class Hash_Decl : public Base {
 ...
 public:
  ...
  const std::list<Statement::Base*> &cutoff_code() const {
    return cutoff_code_;
  }
  const std::list<Statement::Base*> &equal_score_code() const {
    return equal_score_code_;
  }
  const std::list<Statement::Base*> &compare_code() const {
    return compare_code_;
  }
  void set_equal_score_code(const std::list<Statement::Base*> &l) {
    equal_score_code_ = l;
  }
  void set_compare_code(const std::list<Statement::Base*> &l) {
    compare_code_ = l;
  }
};
...
#endif  // SRC_STATEMENT_HASH_DECL_HH_
