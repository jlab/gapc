...
#ifndef SRC_SYMBOL_HH_
#define SRC_SYMBOL_HH_
...
class Base {
 ...
 public:
    ...
    virtual void init_table_dim(const Yield::Size &a, const Yield::Size &b,
    ...
    virtual Runtime::Poly runtime(std::list<NT*> &active_list,
...
class Terminal : public Base {
 ...
 public:
    ...
    void clear_runtime();
    Runtime::Poly runtime(std::list<NT*> &active_list,
...
class NT : public Base {
 ...
 private:
    ...
    void replace(Statement::Var_Decl &decl, Statement::iterator begin,
                 Statement::iterator end);
    void eliminate_list_ass();
    void add_cyk_stub(AST &ast);
    void subopt_header(AST &ast, Fn_Def *score_code, Fn_Def *f,
 ...
 private:
    ...
    void marker_code(const Code::Mode &mode,
                     std::list<Statement::Base*> &ret_stmts,
                     Expr::Base *v) const;
 ...
 public:
    bool multi_detect_loop(const Yield::Multi &left, const Yield::Multi &right,
                           Symbol::NT *nt);
