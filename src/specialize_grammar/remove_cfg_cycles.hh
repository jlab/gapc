...
#ifndef SRC_SPECIALIZE_GRAMMAR_REMOVE_CFG_CYCLES_HH_
#define SRC_SPECIALIZE_GRAMMAR_REMOVE_CFG_CYCLES_HH_
...
namespace SpecializeGrammar {
  ...
  class RemoveCFGCycles {
    ...
    private:
      ...
      std::vector< std::pair< std::string, CFG::Base* > >
        currentProductionFragmentTrace;
    ...
    private:
      ...
      void transformProduction (
        CFG::NonTerminal* productionNT, Util::CallTrace callTrace,
      ...
      CFG::Base* transformCycleElement (
        CFG::Base* b, Util::CallTrace callTrace,
        Util::NamingDomain* namingDomain);
      ...
      // one terminal parser).
      CFG::Base* transformElementStrict (
        CFG::Base* b, Util::CallTrace callTrace,
        Util::NamingDomain* namingDomain);
      ...
      CFG::Base* translateNaming (
        CFG::Base* fragment, Util::NamingDomain* namingDomain);
      ...
      void extractMetaCycleInfoFromTrace (
      ...
      void insertCyclePathsSearchSetElement (
      ...
      void removeCyclePathsSearchSetElement (
        std::string nonTerminalName);
      ...
      std::set<CyclePathInfo*>* getCyclePathsSearchSetElement (
        std::string nonTerminalName);
      ...
      // runs through.
      bool nonTerminalIsBackReference (
...
#endif  // idndef SRC_SPECIALIZE_GRAMMAR_REMOVE_CFG_CYCLES_HH_
