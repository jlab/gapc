...
Statement::SYCL_Buffer_Decl::SYCL_Buffer_Decl(
      ::Type::Base *t, int d, Var_Decl *v, Var_Decl *n)
  : Base(VAR_DECL), type(t), dimension(d), value(v), name(n) {
}

Statement::SYCL_Accessor_Decl::SYCL_Accessor_Decl(
      Var_Decl *v, Var_Decl *c, bool *r, bool *w)
