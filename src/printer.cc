...
void Printer::Base::print(const Statement::Base &stmt) {
  std::cout << "\n called print(const Statement::Base &stmt) of class printer \n";
  if (stmt.is_disabled())
    return;
  stmt.print(*this);
}
...
std::string &Printer::Base::indent() {
  std::cout << "\n called indent() of class printer \n";
  return indent_string;
}


void Printer::Base::set_indent_string() {
  std::cout << "\n called set_indent_string() of class printer \n";
  indent_string = std::string(ind_count*2, ' ');
}


void Printer::Base::inc_indent() {
  std::cout << "\n called inc_indent() of class printer \n";
  ++ind_count;
  set_indent_string();
}
...
void Printer::Base::dec_indent() {
  std::cout << "\n called dec_indent()  of class printer \n";
  assert(ind_count > 0);
  --ind_count;
  set_indent_string();
}
...
void Printer::Base::begin_fwd_decls() {
  std::cout << "\n called begin_fwd_decls() of class printer \n";
  fwd_decls = true;
}

void Printer::Base::end_fwd_decls() {
  std::cout << "\n called end_fwd_decls() of class printer \n";
  fwd_decls = false;
}
...
void Printer::Base::set_argv(char **argv, int argc) {
  std::cout << "\n called set_argv(char **argv, int argc) of class printer \n";
  std::ostringstream o;
